...
\subsection{Menedżer stron --- \texttt{AREAMGR}}

Menedżer stron udostępnia zarządcom niższego poziomu abstrakcję nad pobieraniem
...
Jako strukturę danych do implementacji menedżera stron użyto tablicy list wraz
...
dostępnych bloków poprzez wydłużenie obszar za wierzchołkiem stosu. Menedżer

...
--- w dołączonej przestrzeni tworzy się nową listę bloków, a następnie scala ze
starą; może się zdarzyć, że nowo dołączony obszar będzie przylegał do początku
innego zarządzanego obszaru, wtedy łączy się wszytkie trzy; jeśli nie udało się
powiększyć żadnego obszaru, ostatecznie pobierany jest nowy.

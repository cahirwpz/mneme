...
\paragraph{Semafory POSIX.}

\paragraph{Semafory binarne dla wątków POSIX.}

\paragraph{Mechanizm konstruowania obiektów synchronizacji w przestrzeni
użytkownika.} \verb+futex+

\paragraph{Blokady pętlowe.} (ang. \textit{spin locks})

\paragraph{Atomowe instrukcje procesora.}

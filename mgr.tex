...
\textsc{Teraz pracuję tutaj!}

\paragraph{Wersja uproszczona.} (sama koncepcja)

\paragraph{Wersja pełna.} (ze scalaniem, podziałem i przenoszeniem między listami)

\subsection{Inne algorytmy}

\paragraph{Systemy partnerskie.} (binarne, Fibonnaciego, podwójne)

\paragraph{Mapy bitowe.} (nic wielkiego)

\paragraph{Reaps.} (stos i połączenie listy wolnych bloków)
...
\textsc{Struktura tego rozdziału jeszcze do określenia!}

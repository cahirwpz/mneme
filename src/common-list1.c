 ...
 * Desc:	Semi-template for double linked list
 */
...
void __METHOD_ARGS(__LIST_DECL, push, __ITEM_T *item)
{
...
void __METHOD_ARGS(__LIST_DECL, append, __ITEM_T *item)
{
	if (__LAST(self) == NULL) {
		__SET_PREV(item, NULL);
		__SET_NEXT(item, NULL);
...
__ITEM_T *__METHOD(__LIST_DECL, pop)
{
...
void __METHOD_ARGS(__LIST_DECL, insert, __ITEM_T *item)
{
	if (__FIRST(self) == NULL) {
		/* list is empty */
		__SET_PREV(item, NULL);
...
__ITEM_T *__METHOD_ARGS(__LIST_DECL, search, __KEY_T key)
{
	__ITEM_T *iter = __FIRST(self);
...
void __METHOD_ARGS(__LIST_DECL, remove, __ITEM_T *item)
{
...
void __METHOD_ARGS(__LIST_DECL, split, __LIST_T *list, __ITEM_T *item)
{
	__ITEM_T *iter = __FIRST(self);
...
void __METHOD_ARGS(__LIST_DECL, join, __LIST_T *list)
{
	if (__FIRST(self) == NULL) {
		/* first list is empty */
